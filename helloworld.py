...
class LibraryBookSorter(tk.Tk):
    def __init__(self):
        ...
        self.host = "localhost"  # e.g., "localhost"
        self.user = "root"  # e.g., "root"
    ...
    def create_widgets(self):
        ...
        side_panel = tk.Frame(main_frame, bg="#222222", width=400)
        ...
        options = [("Name", "title"), ("Genre", "genre_name"), ("Year", "publication_year"),("Author", "author_name")] #Changed to match the database
        ...
        self.search_books() # Call search_books to initially populate
    ...
    def populate_book_list(self, book_list):
        ...
        for book in book_list:
            available_text = "Available" if book["Availability"] == "Available" else "Not Available" #Changed to match the query
            display_text = f"{book['BookTitle']} ({book['Genre']}, {book['publication_year']}) - {available_text} - {book['AuthorName']}"  #Added Author
    ...
    def search_books(self):
        ...
        try:
            ...
            # Construct the query.  Use parameters to avoid SQL injection.
            query = """
            SELECT
            ...
            """
            params = ('%' + name_filter + '%',)  # Use a tuple for parameters
            ...
            self.populate_book_list([]) #show no books on error
        finally:
            if connection:
                connection.close()
